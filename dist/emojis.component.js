import { Directive, Component, ElementRef, Input, Output, EventEmitter, ContentChild } from '@angular/core';
export var EmojiInput = (function () {
    ...
    EmojiInput.propDecorators = {
        'emojiInputValue': [{ type: Input },],
    };
    return EmojiInput;
}());
export var EmojisComponent = (function () {
    function EmojisComponent(el) {
        this.el = el;
        this.emojiAdded = new EventEmitter();
        this.emojiCodes = {
            People: [
                "&#x1f601;",
                "&#x1f602;",
    ...
    EmojisComponent.propDecorators = {
        'inputEl': [{ type: ContentChild, args: [EmojiInput,] },],
        'emojiAdded': [{ type: Output },],
    };
